...
object IndexMaker extends IndexMakerLowPriority {
  ...
  implicit def make2V[T[K] <: SeqLike[K], I1: ORD: CLM, I2: ORD: CLM] =
    new IndexMaker[(T[I1], T[I2]), (I1, I2)] {
      def apply(in: (T[I1], T[I2])) = zip2V(in._1, in._2)
    }

  implicit def make3V[T[K] <: SeqLike[K], I1: ORD: CLM, I2: ORD: CLM, I3: ORD: CLM] =
    new IndexMaker[(T[I1], T[I2], T[I3]), (I1, I2, I3)] {
      def apply(in: (T[I1], T[I2], T[I3])) = zip3V(in._1, in._2, in._3)
    }

  implicit def make4V[T[K] <: SeqLike[K], I1: ORD: CLM, I2: ORD: CLM, I3: ORD: CLM, I4: ORD: CLM] =
    new IndexMaker[(T[I1], T[I2], T[I3], T[I4]), (I1, I2, I3, I4)] {
      def apply(in: (T[I1], T[I2], T[I3], T[I4])) = zip4V(in._1, in._2, in._3, in._4)
    }

  implicit def make5V[T[K] <: SeqLike[K], I1: ORD: CLM, I2: ORD: CLM, I3: ORD: CLM, I4: ORD: CLM, I5: ORD: CLM] =
  ...
  private def zip2V[T[K] <: SeqLike[K], A: ORD: CLM, B: ORD: CLM](a: T[A], b: T[B]): Index[(A, B)] = {
  ...
  private def zip3V[T[K] <: SeqLike[K], A: ORD: CLM, B: ORD: CLM, C: ORD: CLM](
  ...
  private def zip4V[T[K] <: SeqLike[K], A: ORD: CLM, B: ORD: CLM, C: ORD: CLM, D: ORD: CLM](
  ...
  private def zip5V[T[K] <: SeqLike[K], A: ORD: CLM, B: ORD: CLM, C: ORD: CLM, D: ORD: CLM, E: ORD: CLM](
...
trait IndexMakerLowPriority {
  ...
  implicit def make1V[T[K] <: SeqLike[K], A: ORD: CLM] = new IndexMaker[T[A], A] {
